...
const ChromaGrid: React.FC<ChromaGridProps> = ({
    ...
    const demo: ChromaItem[] = [
        ...
        {
            image: 'https://images.unsplash.com/photo-1522075469751-3a3694c2d773?auto=format&fit=crop&q=80',
            title: 'Jordan Chen',
        ...
        {
            image: 'https://images.unsplash.com/photo-1554151228-14d9def656ec?auto=format&fit=crop&q=80',
            title: 'Casey Park',
            subtitle: 'Art Aficionado',
            handle: '@caseypark',
            borderColor: '#EF4444',
        ...
        >
            {data.map((c, i) => (
                ...
                >
                    ...
                    />
                    <div className="relative z-10 p-[10px] box-border h-[calc(100%-80px)]">
                        <img src={c.image} alt={c.title} loading="lazy" className="w-full h-full object-cover rounded-[10px]" />
                    </div>
                    <footer className="relative z-10 p-3 text-white font-sans grid grid-cols-[1fr_auto] gap-x-3 gap-y-1 h-[80px]">
                        <h3 className="m-0 text-[1.05rem] font-semibold flex items-center">{c.title}</h3>
                        {c.handle && <span className="text-[0.95rem] opacity-80 text-right flex items-center justify-end">{c.handle}</span>}
